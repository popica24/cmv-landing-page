    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center w-full lg:px-24 p-4">
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-center my-6 w-full p-4">
          <div
            style={{ backgroundImage: "url(industrial-energy.avif)" }}
          ...
          <div className="lg:ms-4" data-aos="fade-right">
            ...
            <p className="sm:text-start text-xs md:text-sm xl:text-base xl:max-w-[79ch]">
              Ne specializăm în oferirea de soluții de energie verde pentru
              clienții din sectorul industrial, punând accentul pe eficiență și
              sustenabilitate. Cu o experiență bogată și o viziune îndrăzneață
              pentru viitor, suntem partenerul de încredere pentru companiile
              care aspiră să fie lideri în adoptarea tehnologiilor ecologice.
            </p>
            <p className="sm:text-start text-xs md:text-sm xl:text-base xl:max-w-[79ch]">
              Ne propunem să transformăm modul în care afacerile industriale își
              gestionează energia, contribuind la reducerea emisiilor de carbon
              și la protejarea resurselor naturale. Împreună, construim un
              viitor mai curat și mai prosper pentru industria de mâine.
            </p>
          </div>
        </div>
      </div>
      <div className="flex flex-col md:flex-row items-center md:items-end md:justify-evenly  justify-center my-8 container mx-auto">
        ...
        <div className="flex flex-col items-center justify-center my-8 md:my-0">
          ...
          <span className="inline-flex items-center text-[47px] font-medium leading-[70px]">
            <CountUp start={5000} end={10000} duration={2} separator="." />+
          </span>
        ...
        <div className="flex flex-col items-center justify-center my-8 md:my-0">
          ...
          >
            <path
              d="M54.2589 25.125C54.057 24.6906 53.7356 24.3234 53.3326 24.0669C52.9296 23.8103 52.4619 23.6751 51.9849 23.6773H51.973L30.3283 23.797L30.1973 23.6534L33.1738 2.88339C33.2533 2.33599 33.1505 1.77752 32.8813 1.29495C32.6122 0.812384 32.1917 0.432814 31.6855 0.215357C31.3662 0.0755841 31.0219 0.00232335 30.6736 0C30.3002 0.00112066 29.932 0.0866609 29.596 0.25028C29.2601 0.413898 28.9651 0.6514 28.7329 0.945178L1.05202 35.6416C0.756278 36.0114 0.570631 36.4578 0.516506 36.9291C0.462382 37.4004 0.541986 37.8775 0.746132 38.3054C0.950278 38.7332 1.27064 39.0942 1.67025 39.3469C2.06986 39.5996 2.53243 39.7336 3.00457 39.7334H22.5181L22.6372 39.8889L17.6367 63.9611C17.5212 64.5118 17.5925 65.0855 17.8393 65.5907C18.0861 66.0959 18.494 66.5036 18.9982 66.7486C19.5024 66.9937 20.0737 67.062 20.621 66.9428C21.1683 66.8236 21.6602 66.5236 22.0181 66.0907L53.9136 27.817C54.2219 27.4487 54.4183 26.9992 54.4795 26.5219C54.5407 26.0446 54.4641 25.5598 54.2589 25.125Z"
              fill="#2F4858"
            />
          </svg>
            ...
            <div className="flex flex-col items-center justify-center">
              <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between w-full">
                <div
                  ...
                  style={{ backgroundImage: "url(smart-device.avif)" }}
                >
                ...
                <div
                  ...
                  style={{ backgroundImage: "url(electrial-install.avif)" }}
                >
                  <div className="absolute inset-0 bg-black bg-opacity-25 rounded-[10px]"></div>
                  <span className="text-white absolute top-6 left-6 text-xl font-roboto">
              ...
              <div
                ...
                style={{ backgroundImage: "url(solar-panels.avif)" }}
              >
                <div className="absolute inset-0 bg-black bg-opacity-25 rounded-[10px]"></div>
                <span className="text-white absolute top-6 left-6 text-xl font-roboto">
      ...
      <div
        ...
        style={{ backgroundImage: "url(solar-park.avif)" }}
      >
