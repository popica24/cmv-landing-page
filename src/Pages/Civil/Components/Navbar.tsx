...
const Navbar = () => {
  return (
    <div className="bg-white flex flex-row items-center justify-between my-10 container mx-auto px-24">
      <Link to={"/"}>
        <img src="hero.png" width={240} />
      </Link>
      <div className="flex flex-row items-center">
        <span className="rounded-[106px] px-[30px] py-[8px] bg-[#2F4858] text-white">
          Civil and Industrial
        </span>
        <span className="rounded-[106px] px-[30px] py-[8px] bg-white hover:bg-[#F26100] hover:text-white cursor-pointer mx-6">
          Solar energy
        </span>
        <span className="rounded-[106px] px-[30px] py-[8px] bg-white hover:bg-[#F26100] hover:text-white cursor-pointer">
          Marin Services
        </span>
      </div>
      <div className="flex flex-row items-center">
