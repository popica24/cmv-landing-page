      ...
      <div className="container mx-auto mt-44">
        <div className="grid grid-cols-3">
          ...
          <div className="col-span-2 ms-24">
            <div className="flex flex-col items-start text-black uppercase font-semibold text-[38px] tracking-wide font-rubik">
              <span className="flex flex-row items-center">
                Construim legături
                <span className="text-linear-gradient font-bold text-[49px] ms-3 font-roboto">
                  DURABILE
                </span>
              </span>
              <span>Nu doar structuri.</span>
            </div>
          </div>
        </div>
      </div>
      <div className="bg-[#2F4858] pt-2">
        <div className="container mx-auto">
          <div className="grid grid-cols-3">
            <div className="col-span-1 relative">
              <div className="-bottom-32 -left-2 absolute">
                <Worker />
              </div>
            </div>
            <div className="col-span-2 ms-24">
              <div className="max-w-[65ch]">
                <span className="text-white font-[200] text-[19px] tracking-wide">
                  Ne concentrăm nu doar pe construirea structurilor, ci și pe
                  consolidarea relațiilor durabile. Fiecare proiect este mai
                  mult decât o clădire, este o investiție în parteneriate de
                  lungă durată.
                </span>
              </div>
              <button className="inline-flex items-center text-white rounded-[164px] border-[3px] border-[#FF6600] px-6 py-1.5 mt-8">
          ...
          <div className="flex flex-row justify-center mt-[12rem]">
            <button
              className={`mx-14 px-[6.5rem] py-2.5 border-2 border-white rounded-t-[30px] font-roboto ${
                civil ? "bg-white text-black" : "bg-transparent text-white"
